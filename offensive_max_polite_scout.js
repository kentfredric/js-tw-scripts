...
function smart_offensive() {
    ...
    var scout_in_time = function(t) { return t/(2 + 5/60) };
    ...
    var can_afford = function(t) {
      ...
      var lcs  = lc_in_time(t/10*9);
      var scouts = scout_in_time(t/10*1);
      var axe_cost = cost_axe(axes);
      var lc_cost  = cost_lc(lcs);
      var scout_cost = cost_scout(scouts);
      if ( lc_cost.wood + axe_cost.wood + scout_cost.wood > budget.wood ) {
          return false;
      }
      if ( lc_cost.clay + axe_cost.clay + scout_cost.clay> budget.clay ) {
          return false;
      }
      if ( lc_cost.iron + axe_cost.iron + scout_cost.iron> budget.iron ) {
          return false;
      }
      if ( lc_cost.pop + axe_cost.pop +scout_cost.pop> budget.pop ) {
          return false;
      }
      return {
        axes: to_int(axes), 
