...
function smart_offensive() {
    ...
    var can_buy = function( res, lc, ma, budget ) { 
      return lc[res] + ma[res] > budget[res];
    };
    ...
    var can_afford = function(t) {
      ...
      if ( can_buy( 'wood', lc_cost, ma_cost, budget )) {
          return false;
      }
      if ( can_buy( 'clay', lc_cost, ma_cost, budget )) {
        return false;
      }
      if ( can_buy( 'iron', lc_cost, ma_cost, budget )) {
        return false;
      }
      if ( can_buy( 'pop', lc_cost, ma_cost, budget )) {
        return false;
      }
